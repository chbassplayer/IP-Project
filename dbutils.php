...
function makeStringSafe($db, $mystring) {
  ...
  //this one orders things differently
  function generateDropdown2($db, $table, $uiVariable, $indexVariable, $defaultValue="") {
   
    // set up a query to get the two variables from the table 
    $query = "SELECT $uiVariable, $indexVariable FROM $table;";
